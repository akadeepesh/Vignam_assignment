    ...
    return (
        <div>
            <section className="h-screen flex flex-col text-[#252424] justify-center items-center   text-center">
                ...
                <p className="mt-16 text-xl">Paste your tweet link below to get started for FREE</p>
                ...
                <div className="relative flex flex-col items-center mt-14 w-[50rem]">
                    ...
                    <p className="mt-2 mb-6 text-sm font-medium text-neutral-400">No signup, no credit card, no crap!</p>
                </div>
            </section>
        </div>
    )
